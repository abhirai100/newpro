...
class Bluethink_Deal_Block_Adminhtml_Deal_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
      ...
      /*$this->addColumn('start_time', array(
          'header'    => Mage::helper('deal')->__('Start_Time(In seconds)'),
          'align'     =>'left',
          'index'     => 'start_time',
      ));

       $this->addColumn('end_time', array(
          'header'    => Mage::helper('deal')->__('End_Time(In seconds)'),
          'align'     =>'left',
          'index'     => 'end_time',
      ));

       $this->addColumn('banner_name', array(
          'header'    => Mage::helper('deal')->__('Banner_Name'),
          'align'     =>'left',
          'index'     => 'banner_name',
      ));
*/
